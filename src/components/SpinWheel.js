...
export default function SpinWheel() {
    ...
    const indianLawQuestions = [
        ...
        {
            question:
                "What is the maximum strength of Lok Sabha as per the Constitution?",
        ...
        {
            question:
                "The Consumer Protection Act was first enacted in which year?",
            options: ["1984", "1986", "1988", "1990"],
            correct: 1,
        },
        {
            question:
                "Which article provides for freedom of speech and expression?",
            options: [
                "Article 19(1)(a)",
                "Article 19(1)(b)",
                "Article 19(1)(c)",
        ...
        {
            question:
                "The concept of 'Basic Structure' was established in which case?",
            options: [
                "Golaknath case",
        ...
        {
            question:
                "Which article provides for prohibition of discrimination?",
        ...
        {
            question:
                "Which commission recommended the three-tier Panchayati Raj system?",
            options: [
        ...
        {
            question:
                "The Sexual Harassment of Women at Workplace Act was passed in:",
            options: ["2011", "2012", "2013", "2014"],
            correct: 2,
        },
        {
            question:
                "Which article provides for the establishment of Finance Commission?",
            options: [
                "Article 280",
                "Article 281",
                "Article 282",
        ...
        {
            question:
                "Which article deals with the procedure for amendment of the Constitution?",
            options: [
                "Article 368",
                "Article 370",
                "Article 371",
        ...
        {
            question:
                "Which article provides for protection against double jeopardy?",
            options: [
                "Article 20(1)",
                "Article 20(2)",
                "Article 20(3)",
        ...
        {
            question:
                "Which section of IPC deals with criminal breach of trust?",
            options: [
                "Section 405",
                "Section 406",
                "Section 407",
        ...
        {
            question:
                "Which article provides for the establishment of Election Commission?",
            options: [
                "Article 324",
                "Article 325",
                "Article 326",
    ...
    const spinWheel = () => {
        ...
        setTimeout(() => {
            ...
            const randomQuestionIndex = Math.floor(
                Math.random() * indianLawQuestions.length
            );
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-white to-stone-50 p-8">
            <div className="bg-white rounded-3xl shadow-xl max-w-4xl mx-auto border border-stone-200">
                {/* Header */}
                <div className="bg-gradient-to-r from-amber-500 to-amber-600 rounded-t-3xl p-8 border-b border-amber-300">
                    <div className="text-center">
                        <h1 className="text-4xl font-bold text-white mb-2 tracking-wide">
                            Legal Knowledge Wheel
                        </h1>
                        <p className="text-amber-100 text-lg font-medium">
                            Spin for surprise legal challenges and questions
                        </p>
                        <div className="mt-4 flex justify-center gap-4">
                            <div className="inline-flex items-center bg-white/20 backdrop-blur-sm px-6 py-2 rounded-full border border-white/30">
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        transition: isSpinning
                                            ...
                                            : "none",
                                        background:
                                            "conic-gradient(from 0deg, #8B4513, #A0522D, #CD853F, #D2B48C, #F4E4BC, #DEB887, #BC9A6A, #9A7B4F, #8B4513)",
                                    }}
                                >
                                    {/* Segments */}
                                    {wheelSegments.map((segment, index) => {
                                        const angle =
                                            ...
                                            index;
                                        const nextAngle =
                                            angle + 360 / wheelSegments.length;
                            ...
                            {!currentQuestion && (
                                <div className="mt-8 text-center">
                                    <button
                                        ...
                                        className={`px-12 py-4 rounded-full font-bold text-lg shadow-lg transition-all ${
                                            isSpinning
                                                ...
                                                : "bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white hover:shadow-xl transform hover:scale-105 active:scale-95"
                                        }`}
                                    >
                                        {isSpinning
                                            ? "Spinning..."
                                    ...
                                    <p className="text-stone-600 text-sm mt-2">
                                        Challenge yourself with legal knowledge
                                    </p>
                                </div>
                            )}
                        </div>
                    ...
                    {currentQuestion && (
                        <div className="bg-white rounded-2xl shadow-xl border border-stone-200 overflow-hidden">
                            ...
                            <div className="p-6">
                                    ...
                                    {currentQuestion.options.map(
                                        (option, index) => (
                                            <button
                                                ...
                                                className={`p-4 rounded-xl font-semibold text-left transition-all transform hover:scale-102 ${getAnswerStyle(
                                                    index
                                                )} ${
                                                    !showResults
                                ...
                                {showResults && (
                                    <div className="text-center bg-gradient-to-r from-stone-50 to-stone-100 p-6 rounded-xl border border-stone-200">
                                        <p
                                        ...
                                        <div className="flex gap-4 justify-center">
                                            <button
                                                onClick={resetGame}
                                                className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white px-8 py-3 rounded-xl font-bold transition-all transform hover:scale-105 active:scale-95 shadow-lg"
                                            >
                                                Spin Again
                                            </button>
                                            <button
                                                onClick={resetAllGame}
                                                className="bg-gradient-to-r from-stone-500 to-stone-600 hover:from-stone-600 hover:to-stone-700 text-white px-8 py-3 rounded-xl font-bold transition-all transform hover:scale-105 active:scale-95 shadow-lg"
                                            >
                                                Reset Game
                                            </button>
                                        </div>
